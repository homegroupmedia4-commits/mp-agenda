...
$options = array(
	...
	'mp_agenda_google_sync_mode',
	'mp_agenda_shared_google_access_token',
	'mp_agenda_shared_google_refresh_token',
	'mp_agenda_shared_google_token_expires_at',
	'mp_agenda_shared_google_calendar_id',
	'mp_agenda_shared_google_email',
	'mp_agenda_gdpr_text',
...
// Supprime les caches de la liste des expéditeurs SMS OVH (transients).
$wpdb->query(
	$wpdb->prepare(
		"DELETE FROM {$wpdb->options} WHERE option_name LIKE %s",
		'%' . $wpdb->esc_like( 'mp_agenda_sms_senders_' ) . '%'
	)
);
